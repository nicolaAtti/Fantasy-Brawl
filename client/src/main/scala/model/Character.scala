...
trait Character {
  ...
  def physicalDamage: Int =
    roundDown(statistics.strength * classMultipliers.strMod) + getModifierValues("PHYS_DAMAGE")
  ...
  def pysicalCriticalDamage: Int =
    roundDown((statistics.strength * classMultipliers.strMod) / 5 + 150) + getModifierValues("PHYS_DAMAGE")
  ...
  /**
    ...
    */
  def speed: Int =
    roundDown((statistics.agility * classMultipliers.agiMod) / 10) + getModifierValues("PHYS_DAMAGE")
  ...
  def criticalChance: Int =
    roundDown((statistics.agility * classMultipliers.agiMod) / 2) + getModifierValues("PHYS_DAMAGE")
  ...
  def magicalDefence: Int =
    roundDown(statistics.spirit * classMultipliers.spiMod) + getModifierValues("PHYS_DAMAGE")
  ...
  def magicalDamage: Int =
    roundDown(statistics.intelligence * classMultipliers.intMod) + getModifierValues("PHYS_DAMAGE")
  ...
  def magicalCriticalDamage: Int =
    roundDown((statistics.intelligence * classMultipliers.intMod) / 10 + 150) + getModifierValues("PHYS_DAMAGE")
  ...
  def physicalDefence: Int =
    roundDown(statistics.resistance * classMultipliers.resMod) + getModifierValues("PHYS_DAMAGE")
